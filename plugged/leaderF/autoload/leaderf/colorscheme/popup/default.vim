...
"    highlight def Lf_hl_popup_inputText guifg=#87ceeb guibg=#4d4d4d gui=NONE ctermfg=117 ctermbg=239 cterm=NONE
    highlight def Lf_hl_popup_inputText guifg=#87ceeb guibg=#4d4d4d gui=NONE ctermfg=white ctermbg=241 cterm=NONE
...
"    highlight def Lf_hl_popup_window guifg=#eeeeee guibg=#404040 gui=NONE ctermfg=255 ctermbg=235 cterm=NONE
    highlight def Lf_hl_popup_window guifg=#eeeeee guibg=#404040 gui=NONE ctermfg=255 ctermbg=233 cterm=NONE
...
"    highlight def Lf_hl_popup_blank guifg=NONE guibg=#4b4e50 gui=NONE ctermbg=239 cterm=NONE
    highlight def Lf_hl_popup_blank guifg=NONE guibg=#4b4e50 gui=NONE ctermbg=241 cterm=NONE
...
"    highlight def Lf_hl_match  guifg=SpringGreen guibg=NONE gui=bold ctermfg=85 ctermbg=NONE cterm=bold
    highlight def Lf_hl_match  guifg=SpringGreen guibg=NONE gui=bold ctermfg=red cterm=bold
    ...
    highlight lineLocation ctermfg=239 guifg=grey30
    highlight def link Lf_hl_lineLocation       lineLocation
    ...
    " the color of `Leaderf line`
    highlight lineLocation ctermfg=239
    highlight def link Lf_hl_lineLocation       lineLocation
    "highlight def link Lf_hl_lineLocation       Comment
